...
- **Audio:** learned to keep playback centralized in [AudioManager](Assets/Scripts/GameScene/Managers/AudioManager.cs) while gameplay events trigger sounds through [PlayerAudio](Assets/Scripts/GameScene/Player/PlayerAudio.cs), [EnemyAudio](Assets/Scripts/GameScene/Enemies/NormalEnemy/EnemyAudio.cs), [BossAudio](Assets/Scripts/GameScene/Enemies/Boss/BossAudio.cs), and [ProjectileAudio](Assets/Scripts/GameScene/Combat/ProjectileAudio.cs); player-configured music and SFX volumes also persist between sessions. See [Persisting Audio Settings](design.md#persisting-audio-settings) for implementation details.
- **Effects:** added hit particles in [ProjectileController](Assets/Scripts/GameScene/Combat/ProjectileController.cs), death particles in [PlayerHealth](Assets/Scripts/GameScene/Player/PlayerHealth.cs) and [BossHealth](Assets/Scripts/GameScene/Enemies/Boss/BossHealth.cs), and a shield indicator managed by [PlayerHealth](Assets/Scripts/GameScene/Player/PlayerHealth.cs).
