...
- **Difficulty progression:** learned to combine timed method calls, weighted random selection, and interpolation to grow enemy waves in [SpawnManager](Assets/Scripts/GameScene/Core/SpawnManager.cs); enemy events trigger sound through [EnemyAudio](Assets/Scripts/GameScene/Enemies/EnemyAudio.cs).
